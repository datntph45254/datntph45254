                ...
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('assets/client/img/staf/1.png') }}" alt>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('assets/client/img/staf/2.png') }}" alt>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('assets/client/img/staf/3.png') }}" alt>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('assets/client/img/staf/4.png') }}" alt>
                        </div>
                    </a>
                </li>
                <li>
                    <a href="#">
                        <div class="member_thumb">
                            <img src="{{ asset('assets/client/img/staf/5.png') }}" alt>
                        </div>
                    </a>
                </li>
                <li>
